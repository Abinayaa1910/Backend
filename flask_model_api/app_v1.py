    ...
    try:
        ...
        for cluster_id in sorted(set(clusters)):
            ...
            persona = {
                ...
                "Interests": ["travel", "relaxation", "sunset cruises"],  # placeholder
                "Writing_Style": "neutral and friendly"
            }
...
def generate_editor_post():
    ...
    print(prompt[:500])  # Print first 500 chars for sanity check
